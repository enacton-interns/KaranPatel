...
const MoodTracker = () => {
    ...
    return (
        <section className='max-w-4xl mx-auto p-4 mt-10 bg-gradient-to-br from-blue-100 to-blue-300 dark:from-gray-900 dark:to-gray-800  rounded-xl shadow-lg'>
            <h2 className=' text-2xl text-semibold mb-4 text-blue-700 dark:text-white'>How are you feeling today?</h2>
